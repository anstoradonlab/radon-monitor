...
call c:\Data\sw\Miniconda3\condabin\conda.bat create -y --prefix ./installervenv python=3.6 pip nsis=3

Rem Activate the packaging environment
call c:\Data\sw\Miniconda3\condabin\conda.bat activate ./installervenv
