...
Welcome to ``ansto_radon_monitor`` contributor's guide.
...
If you experience bugs or general issues with ``ansto_radon_monitor``, please have a look
...
You can help improve ``ansto_radon_monitor`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ansto_radon_monitor`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ansto_radon_monitor``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ansto_radon_monitor.git
    cd ansto_radon_monitor
...
#. Install |pre-commit|_::
   ...
   ``ansto_radon_monitor`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ansto_radon_monitor
.. _issue tracker: https://github.com/<USERNAME>/ansto_radon_monitor/issues
.. <-- end -->
